    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex justify-center">
          <SectionBadge icon={<Send className="w-4 h-4" />} title={t('contact.badge')} />
        </div>
        <div className="mx-auto max-w-2xl text-center">
              ...
              >
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      language === 'en'
                        ? "https://api.whatsapp.com/send?phone=5571996590332&text=Hello,%20Mateus!%20I'm%20contacting%20you%20through%20your%20website!"
          ...
          >
            © {new Date().getFullYear()} Mateus Tosta. {t('contact.rights')}
          </motion.div>
        </div>
      </div>
    </footer>

...
export default function Skills() {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      icon: Brain,
      skills: [
        "LangChain", "CrewAI", "LangFlow", t('skills.ai.verticalAgents'),
        "R.A.G", "Prompt Engineering", t('skills.ai.automation'), "RPA"
      ],
    },
    {
      title: "UX/UI Design",
      icon: Figma,
      skills: [
        "Figma", "Framer", "Design Systems", t('skills.design.prototyping'),
    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex justify-center">
          <SectionBadge icon={<Code className="w-4 h-4" />} title={t('skills.badge')} />
        </div>
